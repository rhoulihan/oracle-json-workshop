...
| 6.2  | Write `public/css/workshop.css` — Oracle-branded styles (see branding spec below), responsive layout, dark/light code blocks                                                  | —                                                                                 |
...
**Oracle Branding Specification (applies to ALL UI pages):**

| Element               | Value                                                                                         |
| --------------------- | --------------------------------------------------------------------------------------------- |
| Primary accent        | Oracle Red `#C74634`                                                                          |
| Header/nav background | Oracle Dark `#312D2A`                                                                         |
| Secondary dark        | `#3A3631`                                                                                     |
| Text on dark          | `#FFFFFF`                                                                                     |
| Body background       | `#F7F6F5` (warm off-white)                                                                    |
| Card/panel background | `#FFFFFF`                                                                                     |
| Body text             | `#312D2A`                                                                                     |
| Font stack            | `'Oracle Sans', 'Source Sans Pro', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif` |
| Code font             | `'Oracle Sans Mono', 'Source Code Pro', 'JetBrains Mono', monospace`                          |
| Logo                  | Oracle logo SVG in header/nav, all pages                                                      |
| Buttons (primary)     | Oracle Red background, white text, subtle shadow                                              |
| Buttons (secondary)   | Oracle Dark outline, transparent background                                                   |
| Links                 | Oracle Red, no underline, underline on hover                                                  |
| Code blocks           | Dark theme (`#1E1E1E` background, syntax highlighted)                                         |
| Progress indicators   | Oracle Red fill on neutral track                                                              |
| Overall aesthetic     | Professional, clean, enterprise — not startup-flashy                                          |

All pages (landing, dashboard, lab viewer, query editor, admin panel) must use this branding consistently. The workshop should look like an official Oracle product.

**Exit Criteria:** Developer can navigate landing → register → dashboard → lab module → see content → copy code. Visual design matches Oracle branding spec.
